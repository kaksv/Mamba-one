...
//           <div>
//             <p className="font-bold text-gray-400">Earnings </p>
//             <p className="text-2xl">63,000 DOTS</p>
//           </div>
//         </div>
//         <div className="mt-6">
//            <Button
//            color="white" bgColor="blue" text="download" border-Radius="10px" size="md"
//            />
//         </div>
//         </div>
//         <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
...
//             className="text-2xl opacty-0.9 rounded-full p-4 hover:drop-shadow-xl">
//              {item.icon}
//             </button>
//             <p className="mt-3">
...
//              <div>
//               <p>
//                 <span className="text-3xl font-semibold">93,400 DOT</span>
//                 <span className="p-1.5 hover:drop-shadow-xl cursor-pointer
//                 rounded-full text-white bg-green-400 ml-3 text-xs">30%
//                 </span>
//               </p>
//               <p className="text-gray-500 mt-1">Budget</p>
//              </div>
//              <div className="mt-8">
//               <p>
//                 <span className="text-3xl font-semibold">42,400 DOT</span>                
//               </p>
//               <p className="text-gray-500 mt-1">Expense</p>
//              </div>
//              <div className="mt-5">
