...
const Sidebar = () => {
  ...
  const normalLink = 'flex item-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-gray-500 text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2';
  ...
  return (
    ...
    pb-10">
      ...
      <div className='flex justify-between items-center'>
         <Link to="/" onClick=
         {handleCloseSideBar}
          className="item-center gap-3 ml-3 mt-4 flex text-xl font-extrabold 
         ...
         <TooltipComponent content="Menu" position="BottomCenter">
          ...
          className="text-xl rounded-full p-3 hover:bg-light-black mt-4 block md:hidden">
            <MdOutlineCancel />
          </button >
         </TooltipComponent>
      </div>
